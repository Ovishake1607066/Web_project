...
namespace _1607066_project_
{
    public partial class ResetPassword : System.Web.UI.Page
    {
        ...
        private void SendPasswordResetEmail(string ToEmail, string UserName, string UniqueId)
        {
            ...
            MailMessage mailMessage = new MailMessage("sen1607066@stud.kuet.ac.bd", ToEmail);
            ...
            sbEmailBody.Append("<br/>"); sbEmailBody.Append("http://localhost:46892/ChangePassword.aspx?uid=" + UniqueId);
            ...
            {
                UserName = "sen1607066@stud.kuet.ac.bd",
                Password = "r1117626789"
            };
