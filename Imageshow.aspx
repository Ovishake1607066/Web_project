<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Imageshow.aspx.cs" Inherits="_1607066_project_.Imageshow" %>
...
<asp:Image ID="Image1" runat="server" Height="412px" Width="468px" />
        ...
        <br />
        <br />
        <asp:Button ID="Button7" runat="server" OnClick="Button7_Click" Text="Next" BackColor="#66CCFF" />
                <br />
        <br />
        <br />
                <br />
