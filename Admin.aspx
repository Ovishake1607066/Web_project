<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Admin.aspx.cs" Inherits="_1607066_project_.Admin" %>
...
<body>
    ...
    <asp:Label ID="Label1" runat="server" Text="Welcome Admin" Font-Bold="true" Font-Size="Large" ForeColor="RoyalBlue"
...
<li style="  float: left;
  border:1px solid #bbb;"><asp:Button ID="Button3" runat="server" Text="Newspapers" OnClick="Button3_Click" BackColor="#FFFFCC" Height="36px" style="font-weight: 700; font-size: large" Width="166px" /></li>
<li style="  float: left;
  border:1px solid #bbb;"><asp:Button ID="Button2" runat="server" Text="Show Files" OnClick="Button2_Click" BackColor="#999966" Height="36px" style="font-weight: 700; font-size: large" Width="191px"  /></li>
      <li style="  float: left;
  border:1px solid #bbb; height: 34px;"><asp:Button ID="Button1" runat="server" Text="Show Images" OnClick="Button1_Click" BackColor="#6699FF" Height="36px" style="font-weight: 700; font-size: large" Width="166px" /></li>
  <li style="  float: left;
...
<div class="mySlides fade">
  ...
  <img src="1.png" style="width:100%;Height:350px">
  
</div>

<div class="mySlides fade">
  
  <img src="2.png" style="width:100%;Height:350px">
</div>

<div class="mySlides fade">
  <img src="3.jpg" style="width:100%;Height:350px">
</div>
